    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        for job_button in job_buttons:  
            ...
            while not collected_successfully:
                try:
                    company_name = driver.find_element(By.CSS_SELECTOR, 'div.css-87uc0g').text
                    location = driver.find_element(By.CSS_SELECTOR, 'div.css-56kyx5').text
                    employer_salary = driver.find_element(By.CSS_SELECTOR, 'span.css-16uanij').text
                    job_title = driver.find_element(By.CSS_SELECTOR, 'div.css-1vg6q84').text
                    job_description = driver.find_element(By.CSS_SELECTOR, 'div.jobDescriptionContent').text   
            ...
            try:
                salary_estimate = driver.find_element(By.CSS_SELECTOR, 'div.css-1bluz6i').text
            except NoSuchElementException:
                salary_estimate = -1 #You need to set a "not found value. It's important."
            
            try:
                rating = driver.find_element(By.CSS_SELECTOR, 'div.css-ey2fjr').text
            except NoSuchElementException:
            ...
            try:
                size = driver.find_element(By.CSS_SELECTOR, 'span.css-19gxme').text
            except NoSuchElementException:
                size = -1
